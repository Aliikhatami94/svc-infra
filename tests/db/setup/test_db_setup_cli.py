...
class TestInitCommand:
    @patch("svc_infra.db.relational.cli.core_init_alembic")
...
class TestRevisionCommand:
    @patch("svc_infra.db.relational.cli.core_revision")
...
class TestUpgradeCommand:
    @patch("svc_infra.db.relational.cli.core_upgrade")
...
class TestDowngradeCommand:
    @patch("svc_infra.db.relational.cli.core_downgrade")
...
class TestCurrentCommand:
    @patch("svc_infra.db.relational.cli.core_current")
...
class TestHistoryCommand:
    @patch("svc_infra.db.relational.cli.core_history")
...
class TestStampCommand:
    @patch("svc_infra.db.relational.cli.core_stamp")
...
class TestMergeHeadsCommand:
    @patch("svc_infra.db.relational.cli.core_merge_heads")
...
class TestScaffoldCommand:
    @patch("svc_infra.db.relational.cli.scaffold_core")
...
class TestScaffoldModelsCommand:
    @patch("svc_infra.db.relational.cli.scaffold_models_core")
...
class TestScaffoldSchemasCommand:
    @patch("svc_infra.db.relational.cli.scaffold_schemas_core")
...
class TestIntegration:
    ...
    def test_database_url_environment_isolation(self, runner):
        with patch("svc_infra.db.relational.cli.core_upgrade") as mock_upgrade:
